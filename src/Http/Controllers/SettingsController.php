...
class SettingsController extends Controller
{
    ...
    {
        $request->validate([
            'max_winners'  => 'required|integer|min:3|max:10',
            'period'  => 'required|integer|min:1|max:90',
        ]);
        setting(['winfleet.max_winners', $request->input('max_winners') ], true);
        setting(['winfleet.period', $request->input('period') ], true);
        setting(['winfleet.integration', $request->input('integration') ], true);
